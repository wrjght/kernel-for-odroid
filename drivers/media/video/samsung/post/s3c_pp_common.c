...
void set_src_addr(s3c_pp_instance_context_t *pp_instance)
{
	...
	if (pp_instance->src_color_space == YC420) {
		...
		buf_addr.src_start_cb	= pp_instance->src_buf_addr_phy_rgb_y + buf_addr.start_pos_cb;	
		buf_addr.src_end_cb   = buf_addr.src_start_cb + buf_addr.end_pos_cb;

		buf_addr.src_start_cr	= pp_instance->src_buf_addr_phy_rgb_y + buf_addr.start_pos_cr;
...
void set_dest_addr(s3c_pp_instance_context_t *pp_instance)
{
	...
	if (DMA_ONESHOT == pp_instance->out_path) {
		...
		if (pp_instance->dst_color_space == YC420) {
			...
			buf_addr.out_src_start_cb = pp_instance->dst_buf_addr_phy_rgb_y 
				                    + buf_addr.out_start_pos_cb;
			buf_addr.out_src_end_cb   = buf_addr.out_src_start_cb 
				                    + buf_addr.out_end_pos_cb;
			buf_addr.out_src_start_cr = pp_instance->dst_buf_addr_phy_rgb_y 
