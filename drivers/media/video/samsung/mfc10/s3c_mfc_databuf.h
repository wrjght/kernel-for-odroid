...
volatile unsigned char *s3c_mfc_get_segment_info_virt_addr(void);
volatile unsigned char *s3c_mfc_get_commit_info_virt_addr(void);
unsigned int s3c_mfc_get_databuf_phys_addr(void);
unsigned int s3c_mfc_get_yuvbuff_phys_addr(void);
unsigned int s3c_mfc_get_segment_info_phys_addr(void);
unsigned int s3c_mfc_get_commit_info_phys_addr(void);
