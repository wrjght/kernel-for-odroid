...
#define S3C_MFC_GET_CONFIG_DEC_H264_CROPINFO		(0x0AA0C004)
...
#define S3C_MFC_SET_CONFIG_ENC_VOPTIMEINCRESOL          (0x0ABDC005)
#define S3C_MFC_SET_CONFIG_ENC_LEVEL                    (0x0ABDC006)
