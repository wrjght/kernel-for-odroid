 ...
 * Macro
 */
#define REGSET_LENGTH(x)	(sizeof(x)/sizeof(struct s5k4ba_reg))
...
/* SQVGA */
static unsigned char s5k4ba_qsvga_reg[][2] =
{
	// Pclk inversion
	{0xfc,0x01},
	{0x01,0x01},
...
#if defined CONFIG_ARCH_S3C64XX
static const struct s5k4ba_reg s5k4ba_wb_outdoor_3001[] = {
	{0xfc, 0x00},
	{0x30, 0x01}
};

static const struct s5k4ba_reg s5k4ba_wb_outdoor_5100[] = {
	{0xfc, 0x00},
	{0x30, 0x02}
};

static const struct s5k4ba_reg s5k4ba_wb_indoor_2000[] = {
	{0xfc, 0x00},
	{0x30, 0x03}
};

static const struct s5k4ba_reg s5k4ba_wb_outdoor_halt[] = {
	{0xfc, 0x00},
	{0x30, 0x04}
};
...
static const unsigned char *s5k4ba_regs_wb_preset[] = {
	(unsigned char *)s5k4ba_awb_on,
	(unsigned char *)s5k4ba_wb_outdoor_3001,
	(unsigned char *)s5k4ba_wb_outdoor_5100,
	(unsigned char *)s5k4ba_wb_indoor_2000,
	(unsigned char *)s5k4ba_wb_outdoor_halt,
