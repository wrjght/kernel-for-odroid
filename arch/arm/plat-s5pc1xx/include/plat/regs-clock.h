...
#define S5P_CLKGATE_D00_RESERVED	(0)
#define S5P_CLKGATE_D00_ALWAYS_ON	(S5P_CLKGATE_D00_INTC |\
			S5P_CLKGATE_D00_TZIC | S5P_CLKGATE_D00_MDMA |\
			S5P_CLKGATE_D00_SECSS | S5P_CLKGATE_D00_CSSYS)
...
#define S5P_CLKGATE_D01_RESERVED	(0)
#define S5P_CLKGATE_D01_ALWAYS_ON	(S5P_CLKGATE_D01_DMC |\
			S5P_CLKGATE_D01_SROMC | S5P_CLKGATE_D01_INTMEM |\
			S5P_CLKGATE_D01_EBI)		

/* PCLKD0 Clock Gate 2 Registers */
#define S5P_CLKGATE_D02_SECKEY		(1<<1)
#define S5P_CLKGATE_D02_SDM		(1<<2)
#define S5P_CLKGATE_D02_RESERVED	(1<<0)
#define S5P_CLKGATE_D02_ALWAYS_ON	(S5P_CLKGATE_D02_SDM |\
					S5P_CLKGATE_D02_SECKEY)
...
#define S5P_CLKGATE_D10_RESERVED	(0)
#define S5P_CLKGATE_D10_ALWAYS_ON	(S5P_CLKGATE_D10_PDMA0 |\
					S5P_CLKGATE_D10_PDMA1)
...
#define S5P_CLKGATE_D11_RESERVED	(0)
#define S5P_CLKGATE_D11_ALWAYS_ON	(0)
...
#define S5P_CLKGATE_D12_RESERVED	(0)
#define S5P_CLKGATE_D12_ALWAYS_ON	(S5P_CLKGATE_D12_MFC)
...
#define S5P_CLKGATE_D13_RESERVED	((1<<4)|(1<<5))
#define S5P_CLKGATE_D13_ALWAYS_ON	(S5P_CLKGATE_D13_PWM |\
		S5P_CLKGATE_D13_APC | S5P_CLKGATE_D13_IEC |\
		S5P_CLKGATE_D13_CHIPID | S5P_CLKGATE_D13_GPIO |\
		S5P_CLKGATE_D13_SYSTIMER | S5P_CLKGATE_D13_RTC)
...
#define S5P_CLKGATE_D14_RESERVED	(0)
#define S5P_CLKGATE_D14_ALWAYS_ON	(S5P_CLKGATE_D14_UART0 |\
			S5P_CLKGATE_D14_UART1 | S5P_CLKGATE_D14_UART2 |\
			S5P_CLKGATE_D14_UART3)
...
#define S5P_CLKGATE_D15_RESERVED	(1<<9)
#define S5P_CLKGATE_D15_ALWAYS_ON	(0)

/* HCLKD2 Clock Gate 0 Registers */
#define S5P_CLKGATE_D20_HCLKD2		(1<<0)
#define S5P_CLKGATE_D20_I2SD2		(1<<1)
#define S5P_CLKGATE_D20_RESERVED	(0)
#define S5P_CLKGATE_D20_ALWAYS_ON	(0)
...
#define S5P_CLKGATE_SCLK0_RESERVED	(0)
#define S5P_CLKGATE_SCLK0_ALWAYS_ON	(S5P_CLKGATE_SCLK0_HPM |\
					S5P_CLKGATE_SCLK0_PWI)
...
#define S5P_CLKGATE_SCLK1_RESERVED	(0)
#define S5P_CLKGATE_SCLK1_ALWAYS_ON	(0)
