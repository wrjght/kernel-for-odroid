...
#define S5PC1XX_PA_IIS0		(0xF2000000)
#define	S3C_PA_IIS_V50		S5PC1XX_PA_IIS0
#define S5PC1XX_PA_IIS1		(0xF2100000)
#define S5PC1XX_PA_IIS2		(0xF2200000)
#define S5PC1XX_PA_PCM0		(0xF2400000)
#define S5PC1XX_PA_PCM1		(0xF2500000)
...
/* TVOUT */
#define S5PC1XX_PA_TVENC	(0xF0000000)
#define S5PC1XX_SZ_TVENC	SZ_1M
#define S5PC1XX_PA_VP		(0xF0100000)
#define S5PC1XX_SZ_VP		SZ_1M
#define S5PC1XX_PA_MIXER	(0xF0200000)
#define S5PC1XX_SZ_MIXER	SZ_1M
#define S5PC1XX_PA_HDMI		(0xF0300000)
#define S5PC1XX_SZ_HDMI		SZ_1M
#define S5PC1XX_PA_CLK_OTHER	(S5PC1XX_PA_SYSCON + 0x100000)
#define S5PC1XX_SZ_CLK_OTHER	SZ_4K

/* SPDIF */
#define S5PC1XX_PA_SPDIF	(0xF2600000)
#define S5PC1XX_SZ_SPDIF	SZ_256
