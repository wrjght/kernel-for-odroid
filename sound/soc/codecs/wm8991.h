...
#define WM8991_SPEAKER_ATTN                     0x22
...
#define WM8991_MCLK	0

extern u8		g_current_out;
extern struct 	timer_list 	detect_timer;

#define WM8991_NONE	0
#define WM8991_SPK	1
#define WM8991_HP	2

extern struct snd_soc_dai wm8991_dai;
extern struct snd_soc_codec_device soc_codec_dev_wm8991;
extern int wm8991_set_outpath(u8 path);
extern void	hkc100_detect_handler(unsigned long data);
